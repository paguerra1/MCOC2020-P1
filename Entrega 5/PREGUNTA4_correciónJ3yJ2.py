# -*- coding: utf-8 -*-
"""
Created on Sun Sep  6 21:08:18 2020
...
plt.figure(1)
plt.subplot(3,1,1)
plt.title("Posición del Sentinel correción J2 y J3")
plt.ylabel("X(t) [KM]")
...
plt.tight_layout()
plt.savefig("Preg4_Posición_correción J2 y J3")
...
plt.title(f" Distancia  correción J2 y J3 $\\delta_{{odeint}} = {delta_odeint[-1]/1000:.1f}$ [Km] , $\\delta_{{eulerint}} = {delta_euler[-1]/1000:.1f}$ [Km]")
plt.ylabel(" $\\delta$ [KM]")
plt.xlabel("Tiempo[hora]")
plt.tight_layout()
plt.legend()
plt.savefig("Preg4_Deriva_EulerintVSOdeint")


plt.figure(3)
plt.plot(hora,delta_euler/1000,label="Eulerint", c="green")
plt.title(f" Distancia correción J2 y J3 $\\delta_{{max}} = {delta_euler[-1]/1000:.1f}$ [Km]")
plt.ylabel(" $\\delta$ [KM]")
plt.xlabel("Tiempo[hora]")
plt.tight_layout()
plt.legend()
plt.savefig("Preg4_Deriva_Eulerint")

plt.figure(4)
plt.plot(hora,delta_odeint/1000,label="Odeint",c="blue")
plt.title(f" Distancia  correción J2 y J3 $\\delta_{{max}} = {delta_odeint[-1]/1000:.1f}$ [Km]")
plt.ylabel(" $\\delta$ [KM]")
plt.xlabel("Tiempo[hora]")
plt.tight_layout(rect=[0,0.03,1,0.95])
plt.legend()
plt.savefig("Preg4_Deriva_Odeint")
plt.show()
